    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "data_split" in active_steps:
            _ = mlflow.run(
                ...
                env_manager="conda",
                parameters={
                    "input": config["etl"]["clean_data"],                # artifact from basic_cleaning
                    "test_size": str(config["modeling"]["test_size"]),   # convert to string for MLproject
        ...
        if "test_regression_model" in active_steps:
            ...
            _ = mlflow.run(
                ...
                env_manager="conda",
                parameters={
                    "mlflow_model": config["model_testing"]["prod_model"],
                    "test_dataset": config["data_split"]["test_artifact"],
                },
            )
